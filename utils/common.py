"""
Common utilities for converting tensors and visualizaitons
"""
...
def log_input_image(x, opts):
    """
    Transfers the tensors based on the given options
    """
    if opts.label_nc == 0:
        return tensor2im(x)
...
def tensor2im(var):
    """
    Converts a given tesnor to an image
    """
...
def tensor2map(var):
    """
    Converts a given tesnor to an map
    """
...
def tensor2sketch(var):
    """
    Converts a given tesnor to a sketch
    """
...
def vis_faces(log_hooks):
    """
    Returns the matplotlib figure for the fface given the log hooks
    """
...
def vis_faces_with_id(hooks_dict, fig, gs, i):
    """
    Returns the matplotlib figure for the fface given the log hooks, and adds
    the simulairity between them
    """
...
def vis_faces_no_id(hooks_dict, fig, gs, i):
    """
    Returns the matplotlib figure for the fface given the log hooks,
    and does not add the simulairity between them
    """
