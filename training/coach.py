...
class Coach:
    """
    Main class for handling training of the model, using TrainOpts
    """
    ...
    def train(self):
        ...
        while self.global_step < self.opts.max_steps:
            for _, batch in enumerate(self.train_dataloader):
                ...
                self.global_step += 1
                del batch, x, y, y_hat, latent

    def validate(self):
        """
        Validates the model and logs the loss using tensorboard
        """
    ...
    def checkpoint_me(self, loss_dict, is_best):
        """
        Saves the models weights and logs the loss into timestamp.txt
        """
    ...
    def configure_optimizers(self):
        """
        Chooses the optimizer based on the option in opts.optim_name
        """
    ...
    def configure_datasets(self):
        """
        Loads in the dataset using ImagesDataset
        """
    ...
    def parse_and_log_images(
        self, id_logs, x, y, y_hat, title, subscript=None, display_count=1
    ):
        im_data = []
